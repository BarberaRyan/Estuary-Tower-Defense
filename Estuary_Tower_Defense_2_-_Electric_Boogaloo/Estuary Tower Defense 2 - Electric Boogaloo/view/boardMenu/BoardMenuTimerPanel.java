...
public class BoardMenuTimerPanel extends JPanel{
	...
	/**
	 * Constructor to create a BoardMenuTimerPanel on the side panel of the screen. 
	 ...
	 * @param timeRatio the ratio of the total time that was started and the current time on the clock
	 */
